...
Ilmentym‰ DataJoukosta voi sis‰lt‰‰ mit‰ tahansa XML:a, se voi olla jopa tyhj‰ XML-tiedosto. Jotkin kehitt‰j‰t voisivat n‰hd‰ t‰m‰n vaihtoehtoisena tapana rakentaa laajennettavia operaatioita, se kuitenkin monimutkistaa ja vaikeuttaa XML-koodin ymm‰rrett‰vyytt‰. T‰llainen suunnittelu siis tekee operaatioista vaikeasti ymm‰rrett‰vi‰ myˆs kolmannen osapuolen palvelun hakijan kannalta.
Esimerkiksi otetaan porttityyppim‰‰rittely nimelt‰‰n "SatunnaisGeneraattori", joka sis‰lt‰‰ yhden operaation jonka signeeraus on "generate():DataJoukko". Nyt t‰m‰n operaation signeeraus ja datatyyppi eiv‰t ole yksik‰sitteisi‰, eik‰ palvelua hakeva henkilˆ pysty p‰‰ttelem‰‰n mik‰ operaation vastaus on muodoltaan ja sis‰llˆlt‰‰n ennen kuin operaatiota kutsutaan. T‰llaiset laajat tyypit eiv‰t yleens‰ kerro sis‰llˆst‰‰n eksplisiittisesti, eik‰ niist‰ silloin helposti esik‰tell‰ termej‰ oikein, joka taas vaikeuttaa lˆydett‰vyytt‰ syntaktisissa rekistereiss‰. \newline
...
T‰m‰n operaation signeerauksesta voidaan p‰‰tell‰, ett‰ operaatio palauttaa yhden satunnaisen luvun. Lis‰ksi n‰hd‰‰n, ett‰ "SatunnainenNumero" laajentaa double-tyyppist‰ primitiivist‰ datatyyppi‰ ja rajoittaa luvun nollan ja ykkˆsen v‰lille. Ihminenkin pystyy p‰‰ttelem‰‰n (kutsumatta palvelua ensin), ett‰ operaatio palauttaa double-tyyppisen desimaaliluvun nollan ja ykkˆsen v‰lilt‰.

\textbf{Piilev‰t virheviestit standardiviesteiss‰}: 

Ajonaikana ilmenneist‰ virheist‰ ilmoittaminen ulostuloviestiss‰ on myˆs huonoa suunnittelutyyli‰. T‰llaisessa tyyliss‰ m‰‰ritell‰‰n ulostuloviesti jonka teht‰v‰n‰ on siirt‰‰ tieto virheviestist‰ kun operaatio ep‰onnistuu, tai esimerkiksi statuskoodi kun operaatio on p‰‰ttynyt. T‰llaisen ulostuloviestin m‰‰rittely vaatii joustavan datatyypin. T‰llainen sek‰ aiheuttaa helposti liian laajaa tyyppim‰‰rittely‰ (mainittu aikaisemmin) ett‰ monimutkaistaa operaation toimintalogiikkaa. Virheviestien l‰hett‰minen ulostuloviesteiss‰ voi vaikuttaa negatiivisesti syntaktisiin rekistereihin, jotka hyˆdynt‰v‰t XML-elementtien nimi‰ ja/tai viestiosien XML-rakennetta\cite{Crasso2008144}.
...
onkoVirheita-osa kertoo tapahtuiko virhett‰. Jos virhe tapahtui, niin viheenAiheuttaja-osa kuvaa virheen aiheuttajan. Jos virhett‰ ei tapahtunut niin virheenAiheuttaja-osa on tyhj‰. Toisaalta, jos virhe tapahtuu, niin kertoma-osa on tyhj‰. Sen lis‰ksi, ett‰ ulostuloviesti l‰hett‰‰ pyydetty‰ tietoa, se myˆs yritt‰‰ kertoa vastaanottavalle taholle mit‰ pit‰isi tehd‰.
...
Voidaan todeta, ett‰ yksinkertaisenkin palvelun m‰‰rittely voi vaikeuttaa perinteisten syntaktisten rekistereiden lˆyt‰mist‰, jos palvelu on WSDL-m‰‰ritelty huonosti. Syntaktisten rekistereiden toiminta on t‰rke‰ olla tiedossa suunnitellessa helposti lˆydett‰vi‰ web-palveluita.
