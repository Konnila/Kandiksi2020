...
%The Redundant datamodels anti-pattern is a problem often caused by a bad %representation of the required data-types.
...
%refactored version of the service description is free from redundant XSD %code.Then, the service definition maybe conciser
